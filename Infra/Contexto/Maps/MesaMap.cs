...
namespace Infra.Contexto.Maps
{
    public class MesaMap : IEntityTypeConfiguration<Mesa>
    {
        public void Configure(EntityTypeBuilder<Mesa> builder)
        {
            ...
            builder.Property(m => m.Numero).IsRequired().HasColumnType("interger");
            builder.Property(m => m.QntCadeira).IsRequired().HasColumnType("interger");
            builder.Property(m => m.QntCliente).IsRequired().HasColumnType("interger");
